...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    oauthSyncModels: '同步模型',
    oauthConnectionRequired: '请先完成 OAuth 登录',
    oauthLoginSuccess: 'OAuth 登录成功',
    oauthLoginFailed: 'OAuth 登录失败',
    oauthDisconnectSuccess: 'OAuth 已断开',
    oauthDisconnectFailed: 'OAuth 断开失败',
    oauthSyncModelsSuccess: '模型已从远端同步',
    oauthSyncModelsFallback: '远端模型同步失败，已使用本地缓存模型列表',
    oauthSyncModelsFailed: '模型同步失败',
    antigravityApiDisabledHint: '当前 GCP 项目未启用 Cloud Code Private API，或当前账号无访问权限',
  ...
  en: {
    ...
    oauthDisconnected: 'Disconnected',
    oauthLogin: 'OAuth Login',
    oauthDisconnect: 'Disconnect OAuth',
    oauthSyncModels: 'Sync Models',
    oauthConnectionRequired: 'Please complete OAuth login first',
    oauthLoginSuccess: 'OAuth login succeeded',
    oauthLoginFailed: 'OAuth login failed',
    oauthDisconnectSuccess: 'OAuth disconnected',
    oauthDisconnectFailed: 'Failed to disconnect OAuth',
    oauthSyncModelsSuccess: 'Models synced from remote',
    oauthSyncModelsFallback: 'Remote sync failed, using cached model list',
    oauthSyncModelsFailed: 'Failed to sync models',
    antigravityApiDisabledHint: 'Cloud Code Private API is disabled for this GCP project, or this account has no access',
